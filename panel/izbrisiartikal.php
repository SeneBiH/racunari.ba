...
?>
  ...
  <body>
    <div class="content">
		<form action="deletearticle.php" method="POST" enctype="multipart/form-data">
    <div class="noviArtikal">
    <h1>Brisanje računara</h1> 
        <input type="number" placeholder="Unesite ID artikla koji želite izbrisati.." name="id" required>
        <button name="brisanjeArtikla" type="submit">Izbrisi računar</button>
      </div>
		</form>
  </div>
